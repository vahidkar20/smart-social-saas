...
trait SSP_Seo {
    ...
    public function handle_analyze_seo_ai() {
        ...
        $platform_tips = [
            'telegram' => 'متن ساده+بولد',
            'bale' => 'متن ساده+بولد',
            'eitaa' => 'متن ساده',
            'rubika' => 'متن ساده',
            'instagram' => '≤2200 کاراکتر, ایموجی',
            'whatsapp' => 'مختصر',
            'website' => 'عنوان 30-60 کاراکتر, meta desc, H2/H3',
            'general' => 'متعادل',
        ];

        $tip = $platform_tips[$platform] ?? $platform_tips['general'];
        $content_preview = mb_substr($content, 0, 500);
        $prompt = "تحلیل سئو فارسی برای {$platform} ({$tip}).\n" .
            "عنوان: {$title}\nمحتوا: {$content_preview}\n\n" .
            "تحلیل باید:\n- واقعی و عملی باشه\n- پیشنهادات قابل اجرا بده\n- اشکالات واقعی رو مشخص کنه\n- فقط اطلاعات تایید شده بده\n\n" .
            "فقط JSON: {\"score\":0-100,\"summary\":\"\",\"strengths\":[],\"weaknesses\":[],\"improvements\":[],\"optimized_title\":\"\",\"optimized_content\":\"\"}";
